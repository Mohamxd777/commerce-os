...
export default function GoodsReceiptsPage({ organizationId }) {
  ...
  return (
    <>
      <PageHeader eyebrow="Purchasing" title={<BusinessTerm term="Goods Receipts" explanation={purchasingTerms['Goods Receipt']} />} description="Immutable delivery evidence with accepted and rejected quantities. Inventory posting is intentionally deferred." />
